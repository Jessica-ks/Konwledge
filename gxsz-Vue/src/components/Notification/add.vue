        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="form-group" :class="{'has-error':nowTitleTips}">
                ...
                <input type="text" class="form-control" id="title" v-model.trim="nowTitle" placeholder="请输入标题...">
            ...
            <div class="col-md-4 col-md-offset-2 col-sm-4 col-sm-offset-2 col-xs-12">
              <!-- <div class="form-group">
                ...
                <div class="input-group radio-height">
                  <el-switch v-model="isFB" on-color="#13ce66" off-color="#ff4949" on-text="是" off-text="否"></el-switch>
                </div>
              </div> -->
            </div>
          </div>
          <div class="row">
            <div class="col-md-6  col-sm-6 col-xs-12">
              ...
              <label>选择学校</label>
              <el-select v-model="nowSch" filterable placeholder="请选择学校..." multiple>
                <el-option v-for="item in schArr" :label="item.label" :value="item.value" :key="item.value">
                </el-option>
              </el-select>
              </div>
            </div>
            <div class="col-md-4 col-md-offset-2 col-sm-4 col-sm-offset-2 col-xs-12">
              <div class="form-group">
                <label>短信通知</label>
                <div class="input-group radio-height">
                  <el-switch v-model="isSMS" on-color="#13ce66" off-color="#ff4949" on-text="是" off-text="否"></el-switch>
                </div>
              </div>
            </div>
          </div>
          <div class="row ">
            <div class="col-md-6  col-sm-6 col-xs-12">
              <div class="form-group" :class="{'has-error':targetTips}">
                <label>选择部门</label>
                <el-select v-model="nowDep" filterable placeholder="请选择部门..." multiple>
          ...
          <div class="row">
            <div class="col-md-6  col-sm-6  col-xs-12">
              <el-upload class="upload-demo" :on-remove="removeThis" ref="imgUpload" :on-success="removeBefore"
                         action="/gxsz_office/index.php?g=notification&m=AdminNotification&a=uploadfile" :file-list="fileArr">
  ...
  export default {
    ...
    methods: {
      ...
      removeThis(file, list) {
        ...
        var config = {
          method: 'get',
          url: '/index.php?g=notification&m=AdminNotification&a=deletefile',
          params: {
      ...
      formSubmit() {
        ...
        if (checkResult && !_this.targetTips) {
          ...
          var config = {
            method: 'post',
            url: '/index.php?g=notification&m=AdminNotification&a=addPost',
            params: {

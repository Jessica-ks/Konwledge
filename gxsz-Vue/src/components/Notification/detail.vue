          ...
          <div class="row">
            <div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8 col-xs-12" style="text-align:center">
              ...
              <div class="desc-wrapper" style="margin-bottom:16px;font-size:14px;">
                ...
                style="margin-left:14px">发表时间:{{DataObj.publish_time}}</span>
              </div>
              ...
              <div class="footer" style="margin-top:16px">
                <span>点击量:{{DataObj.hits}}</span> <span style="margin-left:14px">总人数:{{DataObj.total}}</span> <span
                style="margin-left:14px">已读人数:{{DataObj.readnum}}</span> <span style="margin-left:14px">未读人数:{{DataObj.unreadnum}}</span>
              </div>
            </div>
          </div>
        </div>
...
<script>
  export default{
    ...
    created(){
      ...
      var initConfig = {
        "method": "get",
        "url": "/index.php?g=notification&m=AdminNotification&a=detail",
        "params": {

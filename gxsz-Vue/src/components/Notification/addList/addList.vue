<template>
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="box box-primary" v-loading="Loading" element-loading-text="正在加载中...">
          ...
          <el-table :data="DataArr" style="width: 100%" border>
            ...
            <el-table-column label="标题" prop="title">
              <template scope="scope">
                <el-button @click='go("Notification/AdminNotification/mydetail/"+scope.row.id)' type="text"
                size="small">{{scope.row.title}}
              </el-button>
            </template>
          </el-table-column>
          <el-table-column label="发布时间" prop="modify_time" width="160"></el-table-column>
        ...
        <el-table-column label="操作" width="140">
          <template scope="scope">
            <el-button size="small" @click='go("Notification/AdminNotification/edit/"+scope.row.id)'>编辑</el-button>
    ...
    <script>
      ...
      const initConfig = {
        "method": "get",
        "url": "/index.php?g=notification&m=AdminNotification&a=myAddList",
        "carrier": "DataArr",
        "notAlert": true
      };
      export default{
      ...
      removeSubmit(){
        ...
        var config = {
          "method": 'get',
          "url": '/index.php?g=notification&m=AdminNotification&a=delete',
          "params": {
            "id": _this.temp
          }
        };
